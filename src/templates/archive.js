      ...
      <header>
        <div className='archive__section'>
          ...
          <div className='archive__nav'>
            ...
            <Link to='/category/travel' className={window.location.href.indexOf('category/travel%20tips') > 0 ? 'archive__nav--link selected' : 'archive__nav--link'}>Travel Tips</Link>
            ...
            <Link to='/category/opinion' className={window.location.href.indexOf('category/europe') > 0 ? 'archive__nav--link selected' : 'archive__nav--link'}>Europe</Link>
